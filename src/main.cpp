    ...
    */
    ...
    switch (autonSelector)
        ...
        case 1:
            ...
            chassis.moveToPoint(49, 26, 1300, {.maxSpeed=75});
            intake_motor.move(127);
            rTongue.set_value(true);
            chassis.turnToHeading(0,500);
            chassis.moveToPoint(chassis.getPose().x,chassis.getPose().y + 33,1000);
            pros::delay(300);
            chassis.moveToPoint(chassis.getPose().x + 2,chassis.getPose().y - 40,500, {.forwards = false});
            rTongue.set_value(false);
            pros::delay(1500);
            intake_motor.move(0);
            chassis.moveToPoint(chassis.getPose().x,chassis.getPose().y + 10, 1000);
            chassis.turnToHeading(90,500);
            chassis.moveToPoint(chassis.getPose().x + 17.8,chassis.getPose().y, 1000);
            ...
            // elims right (4 ball descore)
                 chassis.setPose(12, 26, 90);
                 Snacky.set_value(true);
                 chassis.moveToPoint(50, 26,950);
                 chassis.turnToHeading(180,950);
                 rTongue.set_value(true);
                 intake_motor.move(127);
                 chassis.moveToPoint(50, 0,900, {.maxSpeed=75});
                 left_drive.move_velocity(127);
                 right_drive.move_velocity(127);
                 left_drive.move_velocity(0);
                 right_drive.move_velocity(0);
                 chassis.turnToPoint(47.5, 47.5,950, {.forwards = false});
                 chassis.moveToPoint(46.5, 47,950, {.forwards = false, .maxSpeed = 80});
                 chassis.waitUntilDone();
                 pros::delay(500);                
                 rTongue.set_value(false);
                 ...
                 chassis.turnToHeading(90,500);
                 chassis.waitUntilDone();
                 chassis.moveToPoint(chassis.getPose().x + 10.7, chassis.getPose().y , 1000);
                 chassis.waitUntilDone();
                 chassis.turnToHeading(180,500);
                 chassis.moveToPoint(chassis.getPose().x - 2.5 , chassis.getPose().y + 20,  800,{.forwards = false});
                 pros::delay(150);
            ...
            // sawp(my version)
                 ...
                 chassis.setPose(12, 26, 90);
                 Snacky.set_value(true);
                 chassis.moveToPoint(45.7, 26,950);
                 chassis.waitUntilDone();
                 chassis.turnToHeading(180,500);
                 rTongue.set_value(true);
                 intake_motor.move(127);
                 chassis.moveToPoint(45.7, 0,950, {.maxSpeed=75});
                 pros::delay(300);
                 left_drive.move_velocity(127);
                 right_drive.move_velocity(127);
                 left_drive.move_velocity(0);
                 right_drive.move_velocity(0);
                 chassis.moveToPoint(45.6, 46,950, {.forwards = false});
                 pros::delay(500);
                 rTongue.set_value(false);
                 chassis.waitUntilDone();
                 intake_hood_roller.move(127);
                 ...
                 intake_hood_roller.move(0);
                 intake_motor.move(0);
                 chassis.moveToPoint(chassis.getPose().x, chassis.getPose().y - 15, 500);
                 intake_motor.move(127);
                 chassis.moveToPoint(24, 49, 950);
                 chassis.waitUntilDone();
                 chassis.moveToPoint(-35.5, 49, 1500);
                 chassis.waitUntilDone();
                 chassis.turnToHeading(225, 500 );
                 chassis.waitUntilDone();
                 chassis.moveToPoint(-16, 62, 1000,{.forwards = false});
                 chassis.waitUntilDone();
                 ...
                 chassis.moveToPoint(chassis.getPose().x - 33, chassis.getPose().y - 33, 1500);
                 chassis.waitUntilDone();
                 chassis.turnToHeading(180,500);
                 rTongue.set_value(true);
                 intake_motor.move(127);
                 chassis.moveToPoint(chassis.getPose().x,0, 1500);
            break;
            case 9:
         // -------- SKILLS --------
